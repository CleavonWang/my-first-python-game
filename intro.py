...
player1_lives = 100000000000  # initial number of livesm
...
while run:
    ...
    if blade == True:
        ...
        if blade_rect.colliderect(player1_rect):
            player1_lives -= 1
            blade_rect.midbottom = (1000, 1000)  # reset shuricken position
            blade = False
